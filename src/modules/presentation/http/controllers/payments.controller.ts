  ...
  @ApiResponse({
    ...
    schema: {
      example: {
        ...
        init_point:
          'https://www.mercadopago.com.co/checkout/v1/redirect?pref_id=1234567890-abcdef12-3456-7890-abcdef123456',
        sandbox_init_point:
          'https://sandbox.mercadopago.com.co/checkout/v1/redirect?pref_id=1234567890-abcdef12-3456-7890-abcdef123456',
      },
    },
  })
  @ApiResponse({
